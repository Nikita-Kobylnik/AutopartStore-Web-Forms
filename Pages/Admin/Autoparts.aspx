<%@ Page Language="C#" 
    ...
    CodeBehind="Autoparts.aspx.cs" 
    Inherits="AutopartStore2.Pages.Admin.Autoparts" 
    MasterPageFile="~/Pages/Admin/Admin.Master"
    %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" ItemType="AutopartStore2.Models.Autopart" 
        SelectMethod="GetAutoparts"
        DataKeyNames="AutopartId" 
        UpdateMethod="UpdateAutopart" 
        DeleteMethod="DeleteAutopart"
        InsertMethod="InsertAutopart" InsertItemPosition="LastItem" EnableViewState="false"
        runat="server">
        <LayoutTemplate>
        ...
        <EditItemTemplate>
            <tr>
                <td>
                    ...
                    <input type="hidden" name="ProductID" value="<%# Item.AutopartId %>" />
                </td>
                <td>
